...
<header class="front-hero" role="banner">
	...
	<?php get_header(); 
$home_statement_text = get_theme_mod('artistsalliance_home_statement_text');
$home_image_one = get_theme_mod('artistsalliance_home_statement_image_one');
$home_image_two = get_theme_mod('artistsalliance_home_statement_image_two');
$home_about_text = get_theme_mod('artistsalliance_home_about_text');
$home_donate_text = get_theme_mod('artistsalliance_home_donate_text')
?>
	...
	<div class="marketing">
		...
		?>
			...
			<a role="button" class="download large button sites-button hide-for-small-only" href="https://github.com/olefredrik/foundationpress">View Exhibition</a>
		</div>
